...
A browser pass over all 31 staff and portal screens on 2026-09-01 found no
regression: every screen 200s, and the only "school" that renders anywhere is the
four sponsor names and the FAQ's high-school line. It did surface one wart —
validation messages naming `organization_id` rather than "organization" — but that
predates this change and is fixed separately in doc 13's last section.
